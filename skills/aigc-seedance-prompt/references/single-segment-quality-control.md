...
```text
时长：8秒。夜晚开阔地，巨大的飞行器从云层下方缓慢下降，冷蓝色光束落向地面。@图1（Image 1，飞行器外形与材质参考）作为UFO主体；@图2（Image 2，环境与地表空间参考）作为地形、云层和光线基准；@图3（Image 3，主人公外观参考）作为人物脸部、服装和体态参考。无配乐，无旁白，无字幕，无配音，仅保留环境风声、低频空气震动声和尘土被气流卷起的细小声响。

镜头1：远景（WS），低角度，固定机位（locked-off）。@图2（Image 2，环境参考）的开阔地面位于前景，远处云层被冷蓝色光线照亮，@图1（Image 1，飞行器参考）的UFO从云层下方缓慢下降到画面中央。地面草叶被气流压低，少量尘土向外扩散，UFO的光束落点保持在画面中景范围内。

镜头2：中近景（MCU），主人公侧前方角度，缓慢推近（slow push in）。@图3（Image 3，主人公参考）站在画面左侧前景，身体朝向天空中的UFO，衣摆被风向后带起，右手手指轻轻收紧。冷蓝色光线从上方照到主人公脸侧，主人公缓慢抬头看向光束，最后停在仰望姿态，身体仍朝向光束，为下一段走向光束的片段保留接点。主体识别稳定，空间关系清晰，动作承接清楚。
```
