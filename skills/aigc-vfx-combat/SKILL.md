...
- Do not force this stage onto one isolated attack-response beat, a mechanics-only or feasibility/root-cause question, an audit of fixed shots, a supplied reference or event order that already fixes the visible progression, a fixed accepted story, or a pure spectacle with no fight arc. Check the same dramaturgy internally and continue to the owning technical stage.
