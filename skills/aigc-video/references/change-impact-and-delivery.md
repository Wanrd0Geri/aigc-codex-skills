...
| camera position, angle, shot size, axis side, or movement | visible envelope, screen direction, occlusion, gaze readability, perspective, depth compression, focus behavior, world-light relation, and boundaries |
